...
import type { RegisterStudentUseCase } from '@/modules/student/application/usecases/register-student.usecase';
...
describe('RegisterStudentController', () => {
  ...
  let usecaseMock: jest.Mocked<RegisterStudentUseCase>;

  beforeEach(() => {
    validator = makeValidatorFactory(registerStudentSchema);
    usecaseMock = { execute: jest.fn() } as unknown as jest.Mocked<RegisterStudentUseCase>;
    controller = new RegisterStudentController(validator, usecaseMock);
  });
